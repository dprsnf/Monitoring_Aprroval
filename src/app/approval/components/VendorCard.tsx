...
interface VendorCardProps {
    ...
    getDocumentCounts: (documents: Document[]) => { total: number; pending: number; approved: number; rejected: number };
}

export default function VendorCard({ vendor, onVendorClick, getPriorityColor, getDocumentCounts }: VendorCardProps) {
