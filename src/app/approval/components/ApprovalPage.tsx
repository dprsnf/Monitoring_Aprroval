    ...
    const vendorData: VendorData[] = [
        {
            ...
            projectTitle: "Gardu Induk Sawangan 150kV",
            category: "Electrical",
            priority: "high",
            reviewDeadline: "2024-10-15",
            description: "Pembangunan gardu induk 150kV dengan kapasitas 2x60 MVA untuk area Sawangan",
            documents: [
                {
                    id: 1,
                    name: "SLD_GI_Sawangan_Rev01.pdf",
                    filePath: "/documents/sld-gi-sawangan.pdf",
                ...
                {
                    id: 2,
                    name: "Layout_Plan_GI_Sawangan.pdf",
        ...
        },
        {
            ...
            projectTitle: "Substation Likupang 70kV",
            category: "Electrical",
            priority: "medium",
            reviewDeadline: "2024-10-12",
            description: "Upgrade substation 70kV di area Likupang dengan penambahan bay baru",
            documents: [
                {
                    id: 4,
                    name: "SLD_Substation_Likupang.pdf",
                    filePath: "/documents/sld-Likupang.pdf",
                    status: Status.approved,
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <select
                                        ...
                                        className="px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 cursor-pointer text-sm sm:text-base min-w-32"
                                    >
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            {filteredVendors.map((vendor) => {
                                ...
                                return (
                                    <Card
                                        key={vendor.user.id}
                                        className="overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 bg-white/95 backdrop-blur-sm border border-white/30 hover:scale-[1.02]"
                                    >
                                            ...
                                            <div className="flex flex-col lg:flex-row items-start justify-between gap-4">
                                                ...
                                                <div className="w-full lg:w-auto lg:min-w-[300px]">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="w-full bg-[#125d72] hover:bg-[#14a2ba] cursor-pointer text-white shadow-md hover:shadow-lg transition-all duration-200">
