...
import { TechnicalApprovalModalProps } from "@/app/types"; // ✅ FIX: Path import
...
export default function TechnicalApprovalModal({
  ...
  const getModalConfig = () => {
    switch (modalType) {
      ...
      case "reject":
        return {
          title: "Return Document", // ✅ FIX: Ubah judul
          description: `Return document: ${selectedDocument.name} for correction`,
          icon: XCircle,
          iconColor: "text-red-500",
          bgColor: "from-red-50 to-red-100",
          borderColor: "border-red-200",
          buttonText: "Return Document", // ✅ FIX: Ubah teks tombol
      ...
      >
        ...
        >
          <DialogTitle className="flex items-center gap-2">
            <div
              className={`w-8 h-8 ${config.iconColor.replace(
                "text-",
                "bg-",
          ...
          {modalType === "approve" ? (
            <>
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4">
                ...
                <p className="text-sm text-gray-700 mb-1">
                  <strong>Type:</strong>{" "}
                  {selectedDocument.documentType || "N/A"}
                </p>
              ...
              <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                <p className="text-sm text-green-700">
                  <strong>⚠️ Perhatian:</strong> Setelah di-approve, status
                  dokumen akan diperbarui.
                </p>
              </div>
            </>
          ) : (
                ...
                <Textarea
                  ...
                  placeholder={
                    modalType === "approveWithNotes"
                      ...
                      : "Jelaskan alasan pengembalian document ini..."
                  }
                  value={notes}
              ...
              {modalType === "approveWithNotes" && (
                <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                  <p className="text-sm text-blue-700">
                    <strong>Info:</strong> Document akan di-approve dengan
                    catatan tambahan.
                  </p>
                </div>
              )}
