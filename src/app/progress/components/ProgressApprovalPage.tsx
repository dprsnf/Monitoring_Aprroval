...
export default function ProgressApprovalPage() {
            ...
            drawings: [
                {
                    ...
                    priority: "high",
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "completed", completedDate: "2024-10-01", reviewer: "System", description: "File berhasil diunggah dan divalidasi" },
                        { step: 2, title: "Initial Review", status: "completed", completedDate: "2024-10-02", reviewer: "Ir. Ahmad Subandi", description: "Review awal dokumen selesai" },
                        { step: 3, title: "Technical Validation", status: "completed", completedDate: "2024-10-03", reviewer: "Tim Teknis", description: "Validasi teknis selesai" },
                        { step: 4, title: "Final Approval", status: "completed", completedDate: "2024-10-04", reviewer: "Ir. Ahmad Subandi", description: "Dokumen disetujui" }
                    ],
                    comments: [
                        { id: "1", author: "Ir. Ahmad Subandi", date: "2024-10-04 15:30", message: "Dokumen telah sesuai dengan standar PLN dan disetujui untuk implementasi.", type: "approval" },
                        { id: "2", author: "Tim Teknis", date: "2024-10-03 10:15", message: "Validasi teknis selesai, diagram sudah sesuai standar.", type: "info" }
                    ]
                },
                {
                    id: "DOC-002",
                    ...
                    priority: "high",
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "completed", completedDate: "2024-10-01", reviewer: "System", description: "File berhasil diunggah" },
                        { step: 2, title: "Initial Review", status: "current", reviewer: "Ir. Ahmad Subandi", description: "Sedang dalam review awal" },
                        { step: 3, title: "Technical Validation", status: "pending", description: "Menunggu validasi teknis" },
                        { step: 4, title: "Final Approval", status: "pending", description: "Menunggu persetujuan final" }
                    ],
                    comments: [
                        { id: "3", author: "Ir. Ahmad Subandi", date: "2024-10-02 09:30", message: "Dokumen sedang dalam review. Ada beberapa poin yang perlu klarifikasi.", type: "info" },
                        { id: "4", author: "System", date: "2024-10-01 14:36", message: "File berhasil diunggah dan divalidasi.", type: "approval" }
                    ]
                },
                {
                    id: "DOC-003",
                    ...
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "completed", completedDate: "2024-10-01", reviewer: "System", description: "File berhasil diunggah" },
                        { step: 2, title: "Initial Review", status: "completed", completedDate: "2024-10-02", reviewer: "Ir. Ahmad Subandi", description: "Review awal selesai" },
                        { step: 3, title: "Technical Validation", status: "current", reviewer: "Tim Teknis", description: "Sedang dalam validasi teknis" },
                        { step: 4, title: "Final Approval", status: "pending", description: "Menunggu persetujuan final" }
                    ],
                    comments: [
                        { id: "5", author: "Tim Teknis", date: "2024-10-03 14:20", message: "Validasi teknis sedang berlangsung. Layout clearance sedang diperiksa.", type: "info" },
                        { id: "6", author: "Ir. Ahmad Subandi", date: "2024-10-02 16:45", message: "Review awal selesai, diteruskan ke tim teknis untuk validasi.", type: "approval" }
                    ]
                }
            ]
        },
            ...
            drawings: [
                {
                    ...
                    priority: "high",
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "completed", completedDate: "2024-09-30", reviewer: "System", description: "File berhasil diunggah" },
                        { step: 2, title: "Initial Review", status: "current", reviewer: "Ir. Siti Nurhaliza", description: "Review ditahan - perlu revisi" },
                        { step: 3, title: "Technical Validation", status: "pending", description: "Menunggu perbaikan dokumen" },
                        { step: 4, title: "Final Approval", status: "pending", description: "Menunggu perbaikan dokumen" }
                    ],
                    comments: [
                        { id: "7", author: "Ir. Siti Nurhaliza", date: "2024-10-01 11:20", message: "Perhitungan beban angin tidak sesuai standar SNI. Mohon diperbaiki sebelum melanjutkan review.", type: "warning" },
                        { id: "8", author: "System", date: "2024-09-30 16:46", message: "File berhasil diunggah dan divalidasi.", type: "approval" }
                    ]
                },
                {
                    id: "DOC-005",
                    ...
                    priority: "high",
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "current", reviewer: "System", description: "Sedang dalam proses validasi format" },
                        { step: 2, title: "Initial Review", status: "pending", description: "Menunggu validasi format selesai" },
                        { step: 3, title: "Technical Validation", status: "pending", description: "Menunggu review awal" },
                        { step: 4, title: "Final Approval", status: "pending", description: "Menunggu validasi teknis" }
                    ],
                    comments: [
                        { id: "9", author: "System", date: "2024-09-30 16:51", message: "File sedang dalam proses validasi format dan integritas.", type: "info" }
                    ]
                }
            ]
        },
            ...
            drawings: [
                {
                    ...
                    priority: "medium",
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "completed", completedDate: "2024-09-29", reviewer: "System" },
                        { step: 2, title: "Initial Review", status: "completed", completedDate: "2024-09-30", reviewer: "Ir. Bambang Sutrisno" },
                        { step: 3, title: "Technical Validation", status: "completed", completedDate: "2024-10-01", reviewer: "Tim Teknis" },
                        { step: 4, title: "Final Approval", status: "completed", completedDate: "2024-10-01", reviewer: "Ir. Bambang Sutrisno" }
                    ],
                    comments: [
                        { id: "10", author: "Ir. Bambang Sutrisno", date: "2024-10-01 16:30", message: "Layout panel sudah sesuai standar PLN SPLN dan disetujui.", type: "approval" }
                    ]
                },
                {
                    id: "DOC-007",
                    ...
                    comments: [
                        { id: "11", author: "Ir. Bambang Sutrisno", date: "2024-10-01 16:35", message: "Diagram pengawatan sudah benar dan lengkap, disetujui.", type: "approval" }
                    ]
                },
                {
                    id: "DOC-008",
                    ...
                    comments: [
                        { id: "12", author: "Ir. Bambang Sutrisno", date: "2024-10-01 17:00", message: "Setting proteksi sudah sesuai koordinasi dan disetujui.", type: "approval" }
                    ]
                },
                {
                    id: "DOC-009",
                    ...
                    progressSteps: [
                        { step: 1, title: "Document Upload", status: "completed", completedDate: "2024-09-29", reviewer: "System" },
                        { step: 2, title: "Initial Review", status: "completed", completedDate: "2024-09-30", reviewer: "Ir. Bambang Sutrisno" },
                        { step: 3, title: "Technical Validation", status: "current", reviewer: "Tim Teknis", description: "Sedang memverifikasi spesifikasi equipment" },
                        { step: 4, title: "Final Approval", status: "pending", description: "Menunggu hasil validasi teknis" }
                    ],
                    comments: [
                        { id: "13", author: "Tim Teknis", date: "2024-10-02 09:15", message: "Sedang memverifikasi compliance spesifikasi dengan standar PLN.", type: "info" }
                    ]
                }
            ]
        }
    ...
    const filteredData = progressData.filter(vendor => {
        ...
        if (filterStatus !== "all") {
            if (filterStatus === "completed") {
                ...
                matchesFilter = vendor.overallProgress > 0 && vendor.overallProgress < 100;
    ...
    const completedVendors = progressData.filter(v => v.overallProgress === 100).length;
    const inProgressVendors = progressData.filter(v => v.overallProgress > 0 && v.overallProgress < 100).length;
    const onHoldVendors = progressData.filter(v => v.onHoldDocuments > 0).length;
                        ...
                        <CardContent className="p-3 sm:p-4 lg:p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                                    ...
                                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{completedVendors}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="p-3 sm:p-4 lg:p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                                    ...
                                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{inProgressVendors}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-white/95 backdrop-blur border-0 shadow-md hover:shadow-lg transition-all duration-200">
                        <CardContent className="p-3 sm:p-4 lg:p-6">
                            <div className="flex items-center">
                                ...
                                <div className="ml-3 sm:ml-4 min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">On Hold</p>
                                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{onHoldVendors}</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                ...
                {filteredData.length === 0 && (
                    <Card className="bg-white/95 backdrop-blur border-0 shadow-md">
                        <CardContent className="p-6 sm:p-8 lg:p-12 text-center">
                            ...
                            <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-2">No Progress Found</h3>
                            <p className="text-sm sm:text-base text-gray-600 max-w-md mx-auto">
                                No vendor progress matches your current search criteria. Try adjusting your filters or search terms.
                            </p>
                            <Button 
                                onClick={() => {
                                    setSearchTerm("");
                                        ...
                                        <div className="flex flex-col xs:flex-row xs:items-start gap-1">
                                            ...
                                            <div className="flex items-center gap-2 flex-1">
                                                <div className="flex-1 bg-gray-200 rounded-full h-2">
                                                    <div 
                                                        className={`h-2 rounded-full ${getProgressColor(selectedVendor.overallProgress)}`}
                                                        style={{ width: `${selectedVendor.overallProgress}%` }}
                                                    ></div>
                                                </div>
                                                <span className="text-sm font-medium">{selectedVendor.overallProgress}%</span>
                                            </div>
                                        </div>
                                        <div className="flex flex-col xs:flex-row xs:items-start gap-1">
                                            <span className="font-medium text-gray-700 min-w-[100px]">Est. Complete:</span>
                                            <span className="text-gray-900">{new Date(selectedVendor.estimatedCompletion).toLocaleDateString('id-ID')}</span>
                                        </div>
                                        <div className="flex flex-col xs:flex-row xs:items-start gap-1">
                                            <span className="font-medium text-gray-700 min-w-[100px]">Reviewer:</span>
                                            <span className="text-gray-900">{selectedVendor.assignedReviewer}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div className="flex-1 min-w-0 space-y-3">
                                                    ...
                                                    <div className="space-y-1">
                                                        <div className="flex justify-between items-center text-xs">
                                                            <span className="text-gray-600">Step {doc.currentStep} of {doc.totalSteps}</span>
                                                            <span className="font-medium">{Math.round((doc.currentStep / doc.totalSteps) * 100)}%</span>
                                                        </div>
                                                        <div className="w-full bg-gray-200 rounded-full h-1.5">
                                                            <div 
                                                                className={`h-1.5 rounded-full ${getProgressColor((doc.currentStep / doc.totalSteps) * 100)}`}
                ...
                <DialogContent className="max-w-xs sm:max-w-lg lg:max-w-3xl max-h-[95vh] overflow-y-auto m-2 sm:m-4">
                    ...
                    {selectedDocument && (
                        <div className="space-y-4 sm:space-y-6">
                                    ...
                                    <div className="space-y-2 text-xs sm:text-sm">
                                        ...
                                        <div className="flex flex-col xs:flex-row xs:items-start gap-1">
                                            ...
                                            <div className="flex items-center gap-2 flex-1">
                                                <div className="flex-1 bg-gray-200 rounded-full h-2">
                                                    <div 
                                                        className={`h-2 rounded-full ${getProgressColor((selectedDocument.currentStep / selectedDocument.totalSteps) * 100)}`}
                                                        style={{ width: `${(selectedDocument.currentStep / selectedDocument.totalSteps) * 100}%` }}
                                                    ></div>
                                                </div>
                                                <span className="text-xs font-medium">
                                                    {selectedDocument.currentStep}/{selectedDocument.totalSteps}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            {/* Progress Steps */}
                            <div className="space-y-4">
                                <h4 className="text-sm sm:text-base font-semibold text-gray-900">Progress Steps</h4>
                                <div className="space-y-3">
                                        ...
                                        <div key={step.step} className="flex items-start gap-3 sm:gap-4">
                                            <div className="flex-shrink-0">
                                                ...
                                                {index < selectedDocument.progressSteps.length - 1 && (
                                                    <div className={`w-0.5 h-8 sm:h-12 ml-3 sm:ml-4 mt-1 ${
                                                        step.status === 'completed' ? 'bg-green-500' : 'bg-gray-300'
                                                    }`}></div>
                                                )}
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <h5 className="text-xs sm:text-sm font-medium text-gray-900">{step.title}</h5>
                                                {step.description && (
                            ...
                            {selectedDocument.comments && selectedDocument.comments.length > 0 && (
                                <div className="space-y-4">
                                    <h4 className="text-sm sm:text-base font-semibold text-gray-900">Comments & Updates</h4>
                                    <div className="space-y-3 max-h-40 overflow-y-auto">
                                        {selectedDocument.comments.map((comment) => (
                                            <div key={comment.id} className={`p-3 rounded-lg border-l-4 ${
                                                comment.type === 'approval' ? 'bg-green-50 border-green-500' :
                                                comment.type === 'warning' ? 'bg-yellow-50 border-yellow-500' :
                                                comment.type === 'rejection' ? 'bg-red-50 border-red-500' :
                                                'bg-blue-50 border-blue-500'
                                            }`}>
                                                <div className="flex justify-between items-start gap-2 mb-2">
                                                    <span className="text-xs sm:text-sm font-medium text-gray-900">{comment.author}</span>
                                                    <span className="text-xs text-gray-500">{new Date(comment.date).toLocaleString('id-ID')}</span>
                                                </div>
