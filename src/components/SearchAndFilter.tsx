...
interface SearchAndFilterProps {
  ...
  setActiveTab: Dispatch<SetStateAction<"new" | "results">>;
}
        ...
        <div className="mb-4 flex border-b">
          <Button
            ...
            className={`rounded-b-none ${
              activeTab === "new"
                ? "border-b-2 border-[#125d72] text-[#125d72]"
                : "text-gray-500"
            }`}
          >
            Dokumen Baru
            ...
            >
              ...
              {activeTab === "new" ? (
                <>
                  ...
                  {/* Perbaikan: Menghapus '...' yang salah */}
                  <option value={Status.inReviewManager}>
                    In Review Manager
                  </option>
                  {/* Anda mungkin ingin menambahkan status 'inReview' lainnya jika perlu */}
                </>
              ) : (
                <>
