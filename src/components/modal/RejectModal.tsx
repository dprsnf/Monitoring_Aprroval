...
export default function RejectModal({
    ...
    const title = "Reject Document (Final)";
    const subTitleColor = "from-red-800 to-red-900";
    const processText = "❌ Dokumen akan ditolak dan tidak dapat diajukan kembali. Proses ini bersifat final.";
    const buttonText = "Tolak Dokumen";
    ...
    return (
        <div className="fixed inset-0 backdrop-blur-sm bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50">
            <div className="bg-white rounded-lg sm:rounded-xl shadow-2xl max-w-2xl w-full">
                <div
                    className={`bg-linear-to-r ${subTitleColor} text-white p-3 sm:p-4 md:p-6 rounded-t-lg sm:rounded-t-xl`}
                >
                ...
                <div className="p-3 sm:p-4 md:p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <Textarea
                            ...
                            placeholder="Berikan alasan penolakan yang jelas. Catatan ini akan dikirimkan kepada vendor."
                            rows={4}
                            className="w-full"
                        />
                        <p className="text-xs text-gray-500 mt-1">
                            Catatan: Penolakan bersifat final dan dokumen tidak dapat diajukan kembali.
                        </p>
                    </div>
                </div>
